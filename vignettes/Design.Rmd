...
A CSV design file for subsequent use in the 'Conduct' app can be downloaded. Also a PDF report summarising the design, prior information, and simulation results is available for download.
